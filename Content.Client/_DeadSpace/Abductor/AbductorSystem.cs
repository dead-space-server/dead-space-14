...
using Content.Client._DeadSpace.Abductor;
...
namespace Content.Client.DeadSpace.Abductor;
...
public sealed class AbductorCameraConsoleBui : BoundUserInterface
{
    ...
    private void OnStationPressed(int station, List<NavMapBeacon> beacons)
    {
        ...
        {
            var beaconButton = new Button
            {
                Text = beacon.Text,
                Modulate = beacon.Color,
                HorizontalExpand = true,
            };
            beaconButton.StyleClasses.Add("OpenBoth");
            beaconButton.OnPressed += _ =>
            {
    ...
    private void RefreshUI()
    {
        ...
        foreach (var station in state.Stations)
        {
            ...
            stationButton.StyleClasses.Add("OpenBoth");
            stationButton.OnPressed += _ => OnStationPressed(station.Key, station.Value.Beacons);
