...
public sealed class RenegadeShieldAbilitySystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<RenegadeForceShieldAbilityComponent, RenegadeShieldEvent>(OnRenegadeShield);
        SubscribeLocalEvent<RenegadeForceShieldAbilityComponent, ComponentInit>(OnComponentInit);
        SubscribeLocalEvent<RenegadeForceShieldAbilityComponent, ComponentShutdown>(OnComponentShutdown);
    }
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<RenegadeForceShieldAbilityComponent>();
    ...
    private void OnComponentInit(EntityUid uid, RenegadeForceShieldAbilityComponent component, ComponentInit args)
    {
        _actionsSystem.AddAction(uid, ref component.ActionRenegadeShieldEntity, component.ActionRenegadeShield, uid);
    }

    private void OnComponentShutdown(EntityUid uid, RenegadeForceShieldAbilityComponent component, ComponentShutdown args)
    {
        _actionsSystem.RemoveAction(uid, component.ActionRenegadeShieldEntity);
    }

    private void DeleteShield(EntityUid uid, RenegadeForceShieldAbilityComponent component)
    {
    ...
    private void OnRenegadeShield(EntityUid uid, RenegadeForceShieldAbilityComponent component, RenegadeShieldEvent args)
    {
        if (!_gameTiming.IsFirstTimePredicted)
            return;
