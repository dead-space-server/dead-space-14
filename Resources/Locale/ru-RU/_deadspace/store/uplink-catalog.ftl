...
uplink-revive-implanter-desc = Имплант, который начнёт вас лечить когда вы умерете или будете в критическом состояние. В случае вашей смерти, имплант применит эффект дефибриллятора на вас до двух раз, далее эта функция не будет доступна.
