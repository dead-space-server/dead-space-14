...
construction-graph-tag-yellow-flower = жёлтый цветок
construction-graph-tag-dark-flower = чёрный цветок
construction-graph-tag-purple-flower = сиреневый цветок
