...
paperwork-form-title-centcomm-15 = Отчёт о предоставленных жалобах
paperwork-form-title-centcomm-16 = Отчёт о задержанных за смену
paperwork-form-title-centcomm-17 = Отчёт о конфискованном имуществе
paperwork-form-title-centcomm-18 = Отчёт о расстановке постов и патрулей
paperwork-form-title-centcomm-19 = Отчёт о выданном оружии из оружейной брига
paperwork-form-title-centcomm-20 = Отчёт о используемых источниках питания
paperwork-form-title-centcomm-21 = Отчёт о запуске сингулярности
paperwork-form-title-centcomm-22 = Отчёт о настройке системы АТМОС
paperwork-form-title-centcomm-23 = Отчёт о проведённых ремонтных работах
paperwork-form-title-centcomm-24 = Отчёт об одобренных заказах
paperwork-form-title-centcomm-25 = Отчёт о деятельности утилизаторов
paperwork-form-title-centcomm-26 = Отчёт о используемых в интересах ресурсах
paperwork-form-title-centcomm-27 = Отчёт о артефактах
paperwork-form-title-centcomm-28 = Отчёт о аномалиях
paperwork-form-title-centcomm-29 = Отчёт о исследованных технологиях
paperwork-form-title-centcomm-30 = Отчёт о погибших и клонированных за смену
paperwork-form-title-centcomm-31 = Отчёт о произведённых препаратах
paperwork-form-title-centcomm-32 = Отчёт о проведённых сеансах психолога
paperwork-form-title-centcomm-33 = Ответ на приветственный факс
...
paperwork-form-title-security-6 = Отчёт об изучении опасного объекта
...
paperwork-form-title-centcomm-operator-2 = Приказ о контроле за главами
