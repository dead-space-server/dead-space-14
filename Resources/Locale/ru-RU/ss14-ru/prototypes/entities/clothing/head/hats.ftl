...
ent-ClothingHeadHatSecurityTrooper = шапка службы безопасности
    .desc = Зимняя шапка, что согреет вашу голову, если её, конечно, не прострелили.
...
ent-ClothingHeadHatBeretQM = берет квартирмейстера
    .desc = Берет с эмблемой отдела снабжения. Для квартирмейстеров с чувством стиля.
...
ent-ClothingHeadHatBeretWarden = берет смотрителя
    .desc = Фирменный красный берет с эмблемой смотрителя. Для офицеров, которые предпочитают стиль безопасности.
...
ent-ClothingHeadHatHoshat = фуражка главы службы безопасности с золотой кокардой
...
ent-ClothingHeadHatTacticalMaidHeadband = тактическая головная повязка
...
ent-ClothingHeadHatBeretRoboticist = берет робототехника
    .desc = Берет для хорошего робототехника.
