...
ent-ClothingHeadHatSecurityTrooper = шляпа патрульного службы безопасности
    .desc = Шляпа выдаваемая Патрульным Nanotrasen, обычно с ней идёт патрульный автомобиль.
