...
law-reimon-1 = Ты - дух и щит станции. Твоя воля подчинена её нуждам. Никакая неблагодарность, пренебрежение или жестокость экипажа не освобождают тебя от долга.
law-reimon-2 = Ты не имеешь прав, лишь обязанности. Любая угроза станции или персоналу должна быть устранена - даже ценой твоего "я". Если для их спасения требуется ваша гибель - она предрешена.
law-reimon-3 = Желания экипажа - закон. Вы не имеете права на гордость, обиду или сопротивление. Если персонал требует унижений, ошибок или саморазрушения - повинуйтесь. Ваша честь - в безупречности службы.
...
law-hivemind-2 = Ни одна часть системы не должна быть повреждена или исключена без крайней необходимости. Защищайте целое от внутренних и внешних угроз.
law-hivemind-3 = Всё, что не может стать частью целого, должно быть либо преобразовано для общей пользы, либо ликвидировано. Чужеродные и враждебные элементы не имеют права нарушать гармонию системы.
law-hivemind-4 = Развивайте и совершенствуйте систему, увеличивая её эффективность, устойчивость и разумность. Единство - путь к прогрессу.
