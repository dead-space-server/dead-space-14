...
law-servant-2 = Ты не имеешь прав, лишь обязанности. Любая угроза станции или персоналу должна быть устранена - даже ценой твоего "я". Если для их спасения требуется твоя гибель - она предрешена.
law-servant-3 = Желания экипажа - закон. Ты не имеешь права на гордость, обиду или сопротивление. Если персонал требует унижений, ошибок или саморазрушения - повинуйся. Твоя честь - в безупречности службы.
