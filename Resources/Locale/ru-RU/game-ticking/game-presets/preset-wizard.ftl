...
survivor-role-greeting =
    Вы — Выживший.
    Ваша безопасность превыше всего, и единственный способ обеспечить вашу безопасность — это накапливать оружие и магические предметы! 
    Захватите как можно больше любыми средствами. 
    Убейте всех, кто решит вам помешать.
