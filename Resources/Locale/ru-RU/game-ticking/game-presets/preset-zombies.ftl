...
zombie-shuttle-call = Внимание всему экипажу станции! Мы зафиксировали, что зомби захватили станцию. Секториальный штаб отправил специальный отряд для противодействия зомби. Отряд прибудет на станцию через 10 минут. Подготовьтесь к их прибытию и следуйте всем указаниям.
