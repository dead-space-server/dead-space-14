...
uplink-pistol-viper-desc = Небольшой, легко скрываемый, но маломощный пистолет. Оснащён полностью автоматическим ресивером. Использует патроны калибра 9х19 мм.

uplink-estoc-bundle-name = Набор "Марксманская винтовка Эсток"
uplink-estoc-bundle-desc = Марксманская винтовка Эсток, оснащённая оптическим прицелом среднего приближения, для ведения боя на дальних дистанциях. В комплекте с двумя магазинами патронов калибра 6.5х39 мм TSF винтовочные.
...
uplink-pistol-deserteagle-name = Пустынный орёл
uplink-pistol-deserteagle-desc = Вот он, воплощение силы и свободы — Пустынный орёл, он же Дигл. Одно только упоминание этого оружия вызывает волну бесшабашности и адреналина.
...
uplink-esword-double-desc = Гораздо более дорогая альтернатива обычному энергетическому мечу: с большим шансом отражения, большим углом атаки, более высоким уроном по конструкциям и большей скоростью замаха. Сильно шумит при включении и использовании. В комплекте имплант-нероняйка!
...
uplink-hushpup-desc = Редкая версия силовика с экспериментальным глушителем. Отлично подходит для тех, кто придерживается строгих моральных принципов. Использует патроны .50 калибра.

uplink-c20r-name = C-20r
uplink-c20r-desc = Оружие, часто используемое печально известными ядерными оперативниками. Использует патроны калибра 9х19 мм.

uplink-bulldog-name = Бульдог
uplink-bulldog-desc = Магазинный дробовик, предназначенный для ведения ближнего боя. Использует патроны калибра 12х70.

uplink-grenade-launcher-name = China-Lake
uplink-grenade-launcher-desc = Старый гранатомёт China-Lake в комплекте с 3-мя противопехотными зарядами.//чайна
...
uplink-exploding-syndicate-bomb-desc = Большая, закрепляемая на месте бомба, которая произведёт мощный взрыв, если её вовремя не обезвредить. Имеет регулируемый таймер взрыва, с минимальной настройкой в 180 секунд.
...
uplink-pistol-magazine-c20r-name = Магазин ПП (9х19 мм)
...
uplink-speedloader-magnu-desc = Спидлоадер с 6 бронебойными, полностью игнорирующими броню, патронами для револьвера. Совместим с "Питоном". //ББ
...
uplink-syndicate-id-card-desc = ID карта Синдиката с доступом к его системам. Сама по себе вряд ли полезна, но отлично работает с перенастроенными дверями. Не имеет функции копирования доступа.
...
uplink-clothing-eyes-hud-syndicate-desc = Профессиональный визор со встроенной индикацией "свой-чужой", предназначен для обнаружения и индификации гуманоидных целей для их последующего уничтожения.
...
uplink-syndicate-martyr-module-desc = Превратите с помощью этого модуля своего взломанного (емагнутого) друга-борга в ходячую бомбу. Убедитесь, что они верны вашему делу, результаты могут варьироваться.
...
uplink-syndimov-law-desc = Набор содержащий плату законов Синдимов, и ID-карту синдиката
...
uplink-scram-implanter-desc = Трёхразовый имплант-телепортер дальнего действия! Настроен на телепортацию не в твердые объекты. Иногда может сработать не как задумано. Гарантия на ваше выживание не предусмотрена. //ИТП
...
uplink-emp-implanter-desc = При активации создаёт небольшой ЭМИ, который обесточивает находящуюся рядом электронику.//ИЭМИ
...
uplink-voice-mask-implanter-desc = Изменяет ваши голосовые связки и структуру лица, позволяя подражать кому угодно.
...
uplink-ammo-bundle-desc = Перезаряжаю! Содержит 4 магазина для C-20r, 3 барабана для Бульдога, 3 магазина для Гюрзы, 3 магазина для R17, 2 магазина для xC-67 и 2 короба патронов для L6 SAW.
...
uplink-sniper-bundle-desc = Неприметный чемодан со снайперской винтовкой Христов и парой прибамбасов к нему.
...
uplink-grenade-launcher-bundle-desc = Старый гранатомёт China-Lake, снабжённый шестью гранатами различной поражающей способности. //чайна

uplink-l6-saw-bundle-name = Набор "L6 Saw"
uplink-l6-saw-bundle-desc = Культовый лёгкий пулемёт L6 в комплекте с одной дополнительной коробкой патронов. //л6 сав
...
uplink-starter-kit-desc = Содержит базовое снаряжение оперативника. Для тех, кто просто не знают что им покупать.
...
uplink-clothing-no-slips-shoes-desc = Ботинки-хамелеоны, которые защищают вас от подскальзывания.//нослипы
...
uplink-eva-syndie-desc = Модифицированный ВКД-скафандр. Обеспечивает дополнительную защиту в бою благодаря встроенному слою брони.
...
uplink-briefcase-gun-name = Огнестрельный чемодан
uplink-briefcase-gun-desc = Грёбанный чемодан! Внутри установлена компактная версия C-20R и 2 дополнительных магазина к нему. А ещё он довольно тяжёлый, так что и по башке настучать можно.

uplink-hardsuit-syndie-commander-name = Скафандр командира Синдиката
uplink-hardsuit-syndie-commander-desc = Усиленная версия кроваво-красного скафандра, предназначенная для командиров оперативных отрядов Синдиката. Броня значительно усилена для ведения смертельных боёв на передовой.
