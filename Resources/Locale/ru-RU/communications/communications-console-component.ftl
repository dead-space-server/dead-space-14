...
comms-console-menu-recall-ert = Отозвать ОБР
comms-console-menu-first-privileged-id-label = ID-карта с доступом Капитана:
comms-console-menu-second-privileged-id-label = ID-карта с доступом ГСБ:
comms-console-menu-ert-message-placeholder = Причина вызова ОБР...
comms-console-menu-call-ert-status-called = ОБР Вызван
comms-console-menu-eject-button = Извлечь
comms-console-menu-insert-button = Вставить
