...
ui-options-item-sounds-volume = Громкость предметов, выстрелов и шлюзов:
...
ui-options-interface-style = Тема окон и меню:
ui-options-interface-style-dark = Тёмная
ui-options-interface-style-light = Светлая
ui-options-interface-style-classic = Классическая
...
ui-options-admin-strip-overlay-title = Отметки в окне обыска
ui-options-admin-strip-overlay-setting = Показывать отметки при обыске по умолчанию
