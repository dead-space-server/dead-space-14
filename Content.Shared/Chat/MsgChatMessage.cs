...
namespace Content.Shared.Chat
{
    ...
    public sealed class ChatMessage
    {
        ...
        public bool RepeatCheckSender; // RMC14

        [NonSerialized]
        public bool Read;

        public ChatMessage(ChatChannel channel, string message, string wrappedMessage, NetEntity source, int? senderKey, bool hideChat = false, Color? colorOverride = null, string? audioPath = null, float audioVolume = 0, bool repeatCheckSender = true) // RMC14
        {
            Channel = channel;
            Message = message;
            ...
            RepeatCheckSender = repeatCheckSender; // RMC14
        }
    }
