...
namespace Content.Shared.DeadSpace.ChameleonAlive;

public abstract class SharedChameleonAliveSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ChameleonAliveComponent, AfterInteractEvent>(OnInteract);
        SubscribeLocalEvent<ChameleonAliveComponent, GetVerbsEvent<UtilityVerb>>(OnGetVerbs);
        SubscribeLocalEvent<ChameleonAliveComponent, DisguiseToggleNoRotEvent>(OnToggleNoRot);
        SubscribeLocalEvent<ChameleonAliveComponent, DisguiseToggleAnchoredEvent>(OnToggleAnchored);
        SubscribeLocalEvent<ChameleonAliveComponent, HandDeselectedEvent>(OnDeselected);
        SubscribeLocalEvent<ChameleonAliveComponent, GotUnequippedHandEvent>(OnUnequipped);
        SubscribeLocalEvent<ChameleonAliveComponent, ComponentShutdown>(OnProjectorShutdown);
        SubscribeLocalEvent<ChameleonAliveComponent, ItemToggledEvent>(OnProjectorToggled);
    }


    #region Projector

    private void OnInteract(Entity<ChameleonAliveComponent> ent, ref AfterInteractEvent args)
    {
    ...
    private void OnProjectorToggled(Entity<ChameleonAliveComponent> ent, ref ItemToggledEvent args)
    {
        if (args.Activated)
            return;
    ...
    private void OnGetVerbs(Entity<ChameleonAliveComponent> ent, ref GetVerbsEvent<UtilityVerb> args)
    {
        if (!args.CanAccess)
            return;
    ...
    public bool TryDisguise(Entity<ChameleonAliveComponent> ent, EntityUid user, EntityUid target)
    {
    ...
    private void OnToggleNoRot(Entity<ChameleonAliveComponent> ent, ref DisguiseToggleNoRotEvent args)
    {
    ...
    private void OnToggleAnchored(Entity<ChameleonAliveComponent> ent, ref DisguiseToggleAnchoredEvent args)
    {
        if (ent.Comp.Disguised is not {} uid)
            return;
    ...
    private void OnDeselected(Entity<ChameleonAliveComponent> ent, ref HandDeselectedEvent args)
    {
        RevealProjector(ent);
    }

    private void OnUnequipped(Entity<ChameleonAliveComponent> ent, ref GotUnequippedHandEvent args)
    {
        RevealProjector(ent);
    }

    private void OnProjectorShutdown(Entity<ChameleonAliveComponent> ent, ref ComponentShutdown args)
    {
        RevealProjector(ent);
    }
    ...
    /// </summary>
    public bool IsInvalid(ChameleonAliveComponent comp, EntityUid target)
    {
    ...
    /// </summary>
    public void Disguise(Entity<ChameleonAliveComponent> ent, EntityUid user, EntityUid entity)
    {
        var proj = ent.Comp;
    ...
    public bool TryReveal(Entity<ChameleonDisguisedComponent?> ent)
    {
        ...
        if (!TryComp<ChameleonDisguiseComponent>(ent.Comp.Disguise, out var disguise)
            || !TryComp<ChameleonAliveComponent>(disguise.Projector, out var proj))
            return false;
    ...
    private void ClearDisguise(Entity<ChameleonAliveComponent> ent, Entity<ChameleonDisguisedComponent?> disguised)
    {
    ...
    /// </summary>
    public void RevealProjector(Entity<ChameleonAliveComponent> ent)
    {
